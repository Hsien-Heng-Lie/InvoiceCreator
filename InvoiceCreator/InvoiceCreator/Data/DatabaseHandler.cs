...
namespace InvoiceCreator.Data
{
    public static class DatabaseHandler
    {
        ...
        private static string connectionString = @"Data Source=RAHULK\SQLEXPRESS; Database=Invoice_Creator;Integrated Security = True;";
        ...
        {
            string sql = @"INSERT INTO dbo.LevelUp (Name, StartDate, EndDate) VALUES ('" 
                + LevelUpName + @"', '" 
                + startDate + @"', '" 
                + endDate + @"')";
            using (SqlConnection cnn = new SqlConnection(connectionString))
